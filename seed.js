...
// ---------------------------------------------------------------------
// Populates the AAAQMS/ root with example lines, buyers, styles, defects
// and a task so you can try the worker flow immediately.
//
...
export async function seed() {
    ...
    await createIn("productionLines", { name: "Line 02", code: "L02", active: true });
    ...
    // Task assigned to Line 01 — stages & defects defined directly on the task
    await createIn("tasks", {
        taskCode: "TASK-A-001", buyerId: buyer, styleId: style, lineId: line1,
